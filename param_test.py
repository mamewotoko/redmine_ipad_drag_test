...
class TopBottomWebTestCase(WebTestCase):
    ...
    def test_dragging_story(self):
        ...
        target = driver.find_element_by_xpath('//*[@id="stories-for-"]')
    ...
    def test_dragging_task(self):
        ...
        self.save_screenshot(screenshot_file+".png")
        ## TODO: add assert
        task = driver.find_element_by_xpath('//div[@fieldtype="textarea" and text()="task title"][0]')
        target = driver.find_element_by_xpath('//*[@id="1_5"]')
